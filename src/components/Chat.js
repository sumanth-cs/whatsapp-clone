...
import { onSnapshot, doc, addDoc, collection, serverTimestamp, query, orderBy } from 'firebase/firestore'
    ...
    <div className="chat">
      ...
      <div className="chatFooter">
        ...
        >
          ...
          />
          <button type="submit"  style={{border: "none", backgroundColor: "rgb(240, 242, 245);"}} >
            <span className="material-symbols-outlined">send</span>
          </button>
          <button   style={{border: "none", backgroundColor: "rgb(240, 242, 245);"}}>
